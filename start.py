...
match sys.platform:
    case "win32":
        ...
        with open(input("配置文件已写入, 请提供预设的客户端三大金刚配置文件:"), "r") as d:
            ...
            Datas.ClassPlans.write("default", {"ClassPlans": default_confs["ClassPlans"]})
            Datas.TimeLayouts.write("default", {"TimeLayouts": default_confs["TimeLayouts"]})
            Datas.SubjectsSource.write("default", {"Subjects": default_confs["Subjects"]})
